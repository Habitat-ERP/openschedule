...
- Parsers now exist for Schedule 2 trade remedies, Schedule 3 industrial rebates, Schedule 4 rebates,
  ...
  levies. The Schedule 1 excise/levies parser also covers row-bearing Parts 3B, 3C, 3D, 3E, 3F, 5A,
  5B, 6, 7A, and 8. Schedule 1 Parts 3 and 7 are notes-only in the registered SARS PDFs and have no
  levy rows to parse. No parser exists for amendment notices.
